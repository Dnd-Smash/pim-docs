...
The basics of a connector creation have been covered in the previous chapter (cf. :doc:`/import_and_export_data/guides/create-connector`). With the following hands-on practice, we will create our own specific connector.
